...
| # | Project | Topics |
|---|---------|--------|
| 01 | [Network Simulation](./01-network-simulation/) | Cisco Packet Tracer, VLANs, routing, network design |
| 02 | [Port Scanner](./02-port-scanner/) | Python, TCP/UDP scanning, socket programming |
...
| 06 | [Azure Network Simulation](./06-azure-network/) | Cloud architecture, Infrastructure as Code, Cloud security controls, Identity and Access, Monitoring & SIEM |

## Skills Demonstrated

- Network design and troubleshooting (Packet Tracer)
...
I completed these projects as part of the BeCode Cybersecurity Analyst training program.  
My background combines IT support, presales, and a strong interest in cloud security.  
I hold the Comptia Security+ and Azure Administrator Associate (AZ-104) certifications and am currently working toward Azure Cloud and AI Security Engineer Associate (SC-500).  
